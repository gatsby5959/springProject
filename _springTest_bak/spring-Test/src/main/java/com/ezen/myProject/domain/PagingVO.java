...
public class PagingVO {
	...
	//핸들러는 jsp의 페이지를 핸들링 하기 위해?
	
	private String type; //검색 타입
	private String keyword; //검색어

	public PagingVO() {  //기본 생성자를 먼저 적어둬야함 (1페이지에 10개라는뜻?)
		this(1, 10);
	}
	...
	public String[] getTypeToArray() {
		return this.type == null ? new String[] {} : this.type.split(""); //:값을 다 빼서 리턴해주세요.
	}
