                        ...
                        <div class="col-xl-4 col-lg-5">
                            <div class="card shadow mb-4">
									...
									<c:if test="${bvo.image_File ne '' && bvo.image_File ne null}">
										<div>
											<img src="/_fileUpload/${bvo.image_File}" alt="NO Image!!" width="400" height="400">
...
<!--                                 </div> -->
	...
	<a href="/brd/pageList"><button type="button" class="btn btn-outline-success">list</button></a>
	...
	<div>
		...
		<button type=button id = "cmtAddBtn" class="btn btn-outline-success">댓글 등록</button>
	</div>
