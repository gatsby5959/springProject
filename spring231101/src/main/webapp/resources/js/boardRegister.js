...
document.getElementById("trigger").addEventListener("click", () => {
    //id가 'trigger'인 버튼이 눌린 그런 느낌
    document.getElementById("files").click(); //files 아이디를 가지고 있는 것을 클릭  jsp에 style="display: none;"라고 되어있어서 보이진 않음
});
...
const maxSize = 1024 * 1024 * 40; //파일 최대 사이즈(40MB)

document.addEventListener("change", (e) => {
    //'change' => 뭔가 변화가 생겼다면 그 객체에 이벤트 추가
